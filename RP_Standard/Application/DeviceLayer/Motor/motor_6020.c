...
pid_t yaw_pid = {
	.speed.Kp = GM6020_YAW_SP_KP,
	.speed.Ki = GM6020_YAW_SP_KI,
	.speed.Kd = GM6020_YAW_SP_KD,
	.speed.max_iout = SP_MAX_INC_OUT,
	.speed.max_out = SP_MAX_OUT,
	.angle.Kp = GM6020_YAW_AG_KP,
	.angle.Ki = GM6020_YAW_AG_KI,
	.angle.Kd = GM6020_YAW_AG_KD,
	.angle.max_integral = AG_MAX_INTEGRAL,
	.angle.max_out = AG_MAX_OUT,
};

pid_t pitch_pid = {
	.speed.Kp = GM6020_PITCH_SP_KP,
	.speed.Ki = GM6020_PITCH_SP_KI,
	.speed.Kd = GM6020_PITCH_SP_KD,
	.speed.I_Kp = GM6020_INC_SP_KP,
	.speed.I_Ki = GM6020_INC_SP_KI,
	.speed.I_Kd = GM6020_INC_SP_KD,
	.speed.max_iout = SP_MAX_INC_OUT,
	.speed.max_out = SP_MAX_OUT,
	.angle.Kp = GM6020_PITCH_AG_KP,
	.angle.Ki = GM6020_PITCH_AG_KI,
	.angle.Kd = GM6020_PITCH_AG_KD,
//	.angle.I_Kp = GM6020_AG_KP,
//	.angle.I_Ki = GM6020_AG_KI,
//	.angle.I_Kd = GM6020_AG_KD,
	.angle.max_integral = AG_MAX_INTEGRAL,
	.angle.max_out = AG_MAX_OUT,

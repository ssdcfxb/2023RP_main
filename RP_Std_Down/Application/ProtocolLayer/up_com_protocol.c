...
{
	memcpy(up_com_tx_buf_2, (void*)&judge.info->game_robot_status.shooter_id1_17mm_cooling_limit, 2);
	...
	memcpy(&up_com_tx_buf_2[5], (void*)&judge.info->game_robot_status.shooter_id1_17mm_speed_limit, 2);
	CAN_SendData(&hcan2, 0x101, up_com_tx_buf_2);
}

void up_send_shoot(void)
{
	memcpy(up_com_tx_buf_3, (void*)&judge.info->shoot_data.bullet_speed, 4);
	memcpy(&up_com_tx_buf_3[4], (void*)&judge.info->power_heat_data.shooter_id1_17mm_cooling_heat, 2);
	memcpy(&up_com_tx_buf_3[6], (void*)&judge.info->power_heat_data.chassis_power_buffer, 2);
	CAN_SendData(&hcan2, 0x102, up_com_tx_buf_3);
}

void up_send_robot_pos(void)
{
	memcpy(up_com_tx_buf_4, (void*)&judge.info->game_robot_pos.yaw, 4);
//	CAN_SendData(&hcan2, 0x103, up_com_tx_buf_4);
}
...
//		CAN_SendData(&hcan2, 0x104, up_com_tx_buf_5);
	}
}
